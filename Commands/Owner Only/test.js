...
module.exports = {
	...
	async execute(bot, message, args, settings) {
		...
		async function start() {
			var API = new ampapi.AMPAPI("http://web.voxxie.me:8080/");
			try {
				...
				var loginResult = await API.Core.LoginAsync("MsVoxxie", "Rikapoo12", "", false);
				if (loginResult.success) {
					...
					var Ints = await API.ADSModule.UpgradeInstance;
					console.log(Ints);
				}
				else {
